...
from src.layers.layer_input import LayerInput
from src.loss.activation_softmax_loss_categorical_crossentropy import ActivationSoftmaxLossCategoricalCrossentropy
...
class Model:
    ...
    def create_data_mnist(self, path):
        ...
        X_test, y_test = self.path.load_mnist_dataset('test', path)
